 ...
 */
public abstract class HyperflLightCodeInsightFixtureTestCase extends LightCodeInsightFixtureTestCase {

    @Override
    public void setUp() throws Exception {
        super.setUp();
        HyperfSettings.getInstance(myFixture.getProject()).pluginEnabled = true;
    }
